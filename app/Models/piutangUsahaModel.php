...
class piutangUsahaModel extends Model
{
    ...
    protected $allowedFields = ['id_user', 'minggu-ke', 'id_purchase_order_detail', 'jenis', 'id_purchase_order', 'id_supplier', 'nama_penghutang', 'tgl_piutang', 'id_branch', 'jumlah_piutang', 'type_piutang'];
