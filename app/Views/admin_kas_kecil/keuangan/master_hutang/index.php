                                    ...
                                    ?>
                                        <tr>
                                            <td style="font-size: 11px;">
                                                <a href="<?= base_url('/akk/keuangan/master_hutang/hapus/' . $value['id_piutang_usaha']) ?>" onclick="return confirm('Apakah Anda yakin Menghapus Data Piutang Usaha ?')" style="text-decoration: none;"><b>
                                                        <?= $no ?></b>
                                                </a>
                                            </td>
                                            <td style="font-size: 11px;">
                                                <a href="<?= base_url('/akk/keuangan/master_hutang/edit/' . $value['id_piutang_usaha']) ?>" style="text-decoration: none;"><b>
                                            ...
                                            <b><a href="<? #= base_url('/akk/keuangan/master_hutang/') 
                                                ...
                                                <b><a data-bs-toggle="modal" data-bs-target="#exampleModal<?= $value['id_piutang_usaha'] ?>" style="text-decoration:none" data-toggle="tooltip" class="tip-top" data-original-title="Bayar Lunas"><i class="mdi mdi-check-circle text-default icon-md"></i></a></b>
                                                <b> <a href="<?= base_url('/akk/keuangan/master_hutang/cicilan/' . $value['id_piutang_usaha']) ?>"><i class="mdi mdi-cash-100 icon-md"></i></a></b>
                                            </td>
                                        </tr>
