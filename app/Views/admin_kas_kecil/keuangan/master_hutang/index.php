                                        ...
                                        <tr>
                                            ...
                                            <td class="warning" align="center" width="10px">
                                                <b><a href="<? #= base_url('/akk/keuangan/master_hutang/') 
                                                            ?>" style="text-decoration:none" data-toggle="tooltip" class="tip-top" data-original-title="Discount Hutang Usaha"><i class="mdi mdi-ticket-percent text-default icon-md"></i></a></b>
                                                <b><a href="<? #= base_url('/akk/keuangan/master_hutang/') 
                                                            ?>" style="text-decoration:none" data-toggle="tooltip" class="tip-top" data-original-title="Retur Hutang"><i class="mdi mdi-file-send text-default icon-md"></i></a></b>
                                                <b><a href="<?= base_url('/akk/keuangan/master_hutang/pelunasan/' . $value['id_piutang_usaha'])
                                                            ?>" style="text-decoration:none" data-toggle="tooltip" class="tip-top" data-original-title="Bayar Tagihan"><i class="mdi mdi-check-circle text-default icon-md"></i></a></b>
                                            </td>
                                        </tr>
                                    <?php }
                                    $no++; ?>
