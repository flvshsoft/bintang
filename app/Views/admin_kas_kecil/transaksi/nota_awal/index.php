                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <a class="btn btn-success btn-xs"
                                    href="<?= base_url('/akk/transaksi/nota_awal/tambah') ?>">
                            ...
                            <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="<?= base_url('/akk/transaksi/nota_awal/detail/' . $value['id_sales']) . '/' . 'CASH' ?>">
                                                <i class="mdi mdi-plus-circle text-default icon-md"></i>
                                            </a>

                                            <a
                                                href="<?= base_url('/akk/transaksi/nota_awal/print_penjualan_barang/' . $value['id_sales']) ?>">
