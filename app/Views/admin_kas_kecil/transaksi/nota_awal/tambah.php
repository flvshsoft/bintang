        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('/akk/transaksi/nota_awal') ?>"> Do</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST"
                            action="<?= base_url('/akk/transaksi/nota_awal/tambah') ?>">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="km" class="form-control form-control-sm"
                                        placeholder="Masukkan km" required>
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="datetime-local" class="form-control form-control-sm" rows="3"
                                        name="tgl_do" value="<?= date('Y-m-d H:i:s') ?>">
                                </div>
                            </div>
                            <div class="form-group row mb-1">
                            ...
                            <div class="form-group mb-0 text-center">
                                ...
                                <a href="<?= base_url('/akk/transaksi/nota_awal') ?>" class="btn btn-light btn-xs">
