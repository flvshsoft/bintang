                                    ...
                                    <a class="text-black text-decoration-none">
                                        <div class="d-flex align-items-start flex-column justify-content-center">
                                            <h6 class="preview-subject ellipsis mb-0 font-weight-normal">
                                                NO DO : <?= $info['id_sales'] ?>
                                                <input type="hidden" name="id_sales" class="form-control" value="<?= $info['id_sales'] ?>">
                                                <input type="hidden" name="id_partner" class="form-control" value="<?= $info['id_partner'] ?>">
                                            </h6>
                                            <p class="text-gray mb-0"> Area : <?= $info['nama_area'] ?> </p>
                                            <input type="hidden" name="id_area" class="form-control" value="<?= $info['id_area'] ?>">
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-7 justify-content-center">
                                    <div class="form-group d-flex">
                                        ...
                                        ?>
                                        <a href="<?= base_url('akk/transaksi/nota_awal/detail/' . $info['id_sales'] . '/' . $payment_method2) ?>" class="btn"><i class="mdi mdi-sync"></i></a>
                                    </div>
                                        ...
                                        <div class="row justify-content-right mb-1">
                                            <div class="col-md-12">
                                                <div class="form-group d-flex">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" id="pay" name="total_beli" class="form-control" required>
                                                    </div>
                                                </div>
