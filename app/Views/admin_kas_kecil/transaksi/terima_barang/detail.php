                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" width="100%" height="88%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <form action="<?= base_url('/akk/transaksi/terima_barang/detail') ?>"
                                            method="post">
                                            <input type="hidden" name="id_purchase_order" class="form-control"
                                                value="<?= $id_purchase_order ?>">
                                            <td style="font-size: 11px;">#</td>
                                            <td style="font-size: 11px;">
                                                <select class="form-control form-control-sm" id="id_product"
                                                    name="id_po_dan_produk" required>
                                                    ...
                                                    <?php if ($jumlah > 0) { ?>
                                                    <option
                                                        value="<?= $value['id_purchase_order_detail'] ?>,<?= $value['id_product'] ?>">
                                                        <?= $value['id_product'] ?>
                                                        -
                                                        <?= $value['nama_product'] ?>
                                                        -
                                            ...
                                            <td style="font-size: 11px;">
                                                <input type="text" readonly class="form-control" id="jumlah_product"
                                                    name="jumlah_product">
                                            </td>
                                            <td style="font-size: 11px;">
                                                <input type="text" name="jumlah_masuk" class="form-control" id="pay"
                                                    value="0">
                                            </td>
                                            <td style="font-size: 11px;">
