                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="return confirm('Anda Yakin Ingin Menghapusnya?')" href="<?= base_url('/akk/transaksi/tagihan_baru/nota/detail/hapus/' . $value['id_nota'] . '/' . $value['id_nota_detail']) . '/' . $harga . '/' .  $value['satuan_penjualan'] . '/' .  $value['id_sales'] . '/' .  $value['id_product'] ?>">
