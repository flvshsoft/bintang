    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('/akk/transaksi/tagihan_baru/closing-sales') ?>" method="POST">
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="<?= base_url('/akk/transaksi/tagihan_baru') ?>" class="btn btn-primary btn-rounded btn-fw" name="btn_s">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
