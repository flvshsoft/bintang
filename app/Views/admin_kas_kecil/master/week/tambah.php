                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?= base_url('/akk/master_week/tambah') ?>">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm" name="nama_week"
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="number" class="form-control form-control-sm" name="bulan_week"
                                        placeholder="Bulan Week"></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-0">
