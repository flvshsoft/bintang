                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                <a class="btn btn-gradient-success btn-xs btn-icon-text my-1"
                                    href="<?= base_url('/akk/master_week/tambah') ?>">
                                    <i class="mdi mdi-database-plus icon-sm"></i> Input Week</a>
                                <a class="btn btn-gradient-warning btn-xs btn-icon-text my-1"
                                    href="<?= base_url('/akk/master_week/generate') ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 11px;">
                                            <b>
                                                <a style="text-decoration:none"
                                                    href="<?= base_url('/akk/master_week/edit/' . $value['id_week']) ?>">
                                                    <?= $value['nama_week'] ?>
                                                </a>
                                            </b>
                                        </td>
                                        ...
                                        <td style="font-size: 11px;">
                                            <a onclick="return confirm('Anda Yakin Ingin Menghapusnya?')"
                                                href="<?= base_url('/akk/master_week/hapus/' . $value['id_week']) ?>">
