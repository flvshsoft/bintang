...
$sheetIndex = 2; // Change this to the index of the sheet you want
    ...
    if ($data[0][0] != "") {
        ...
        if ($row_sql) {
            ...
            if ($row_sql2) {
                ...
                print_r(
                    [
                        $worksheet->getTitle() => 'Tidak Ada Partner/Salesman',
                        'Nama Salesman' => $data[0][1],
                        'Branch' => $data[0][4],
                    ]
                );
                print_r($data[0]);
            ...
            print_r(
                [
                    $worksheet->getTitle() => 'Tidak Ada Area',
                    'Nama Area' => $hitung['area']
                ]
            );
        }
        // print_r($hitung);
        ...
        if (isset($hitung['id_sales'])) {
            foreach ($data2 as $key => $value) {
                ...
                if ($row_sql) {
                    ...
                    print_r(
                        [
                            $worksheet->getTitle() => 'Tidak Ada Customer',
                            'Nama Customer' => $value[3]
                        ]
                    );
                    print_r($value);
                }
